...
describe("parseXrefStream", () => {
  ...
  it("honors /Index for sparse object ranges", async () => {
    const entryBytes = new Uint8Array([
      ...
      0x00,
      0x0a,
      0x00, // type 1, offset 10, gen 0
      1,
      0x00,
      0x00,
      0x14,
      0x00, // type 1, offset 20, gen 0
    ]);
    const compressed = await deflate(entryBytes);
